...
namespace MFarm.AStar
{
    public class AStar : Singleton<AStar>
    {
        ...
        public void BuildPath(string sceneName, Vector2Int startPos, Vector2Int endPos,Stack<MoveStep> npcMovementStep)
        {
            pathFound = false;
        ...
        /// <param name="sceneName"></param>
        /// <param name="npcMovementStep"></param>
        private void UpdatePathOnMovementStepStack(string sceneName,Stack<MoveStep> npcMovementStep)
        {
            Node nextNode = targetNode;
            while (nextNode != null)
            {
                MoveStep newStep = new MoveStep();
