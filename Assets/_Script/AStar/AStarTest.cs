...
namespace MFarm.AStar
{
    public class AStarTest : MonoBehaviour
    {
        ...
        private Stack<MoveStep> npcMovmentStepStack;
        ...
        private void Awake()
        {
            ...
            npcMovmentStepStack = new Stack<MoveStep>();
        }
        ...
        private void Update()
        {
            ...
            {
                moveNPC = false;
                var schedule = new ScheduleDetails(0, 0, 0, 0, Season.春天, targetScene, targetPos, animationClip, true);
